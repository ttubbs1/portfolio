...
const ProjectComponent = ({
    ...
    const [isActive, swapActive] = useState(false);
    const handleClick = () => {
        swapActive(!isActive);
        showModal();
    };
    return (
        <div style={{ width: "100%", display: "contents" }}>
            <div className="projectBox projectSidebar">
                <img
                    src={image}
                ...
                <div className="projectTitleWrapper">
                    <h3 className="subHeading projectTitle openSansLight">
                        {title}
                    </h3>
                </div>

                <span>
                    <a className="iconWrapper" onClick={handleClick}>
                        <svg
