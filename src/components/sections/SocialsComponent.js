...
const SocialsComponent = () => {
    return (
        <footer
            id="Socials"
            className="socialsSection socialsSectionResponsive"
        >
            <p className="iter" style={{ color: "#52525b" }}>
                ttubbsjr@gmail.com
            </p>
            <div className="socialsWrapper">
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.linkedin.com/in/thomas-tubbs-88b3a9240/"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
